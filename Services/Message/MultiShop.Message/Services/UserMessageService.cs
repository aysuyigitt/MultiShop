...
namespace MultiShop.Message.Services
{
    public class UserMessageService : IUserMessageService
    {
        ...
        {
            var values = await _messageContext.UserMessages.Where(x => x.ReceverId == id).ToListAsync();
        ...
        //{
        //   var values = await _messageContext.UserMessages.Where(x=>x.ReceverId==id).CountAsync();
        //    return values;
        //}
