...
namespace MultiShop.WebUI.Services.CatalogService.CommentServices
{
    public class CommentService : ICommentService
    {
        ...
        public async Task<int> GetActiviteCommentCount()
        {
            var responseMessage = await _httpClient.GetAsync("comments/GetActiviteCommentCount");
